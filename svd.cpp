...
void SVD::solve(VecDoub_I &b, VecDoub_O &x, Doub thresh) {
	Int i,j,jj;
	Doub s;
...
void SVD::solve(MatDoub_I &b, MatDoub_O &x, Doub thresh)
{
	int i,j,p=b.ncols();
...
MatDoub SVD::nullspace(Doub thresh){
	Int j,jj,nn=0;
